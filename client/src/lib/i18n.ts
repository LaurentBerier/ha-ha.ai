...
export const copy = {
  fr: {
    ...
    hero: {
      ...
      waitlistDescription: 'Crée ton compte et accède directement à ton expérience personnalisée.',
    },
    whatItIs: {
  ...
  en: {
    ...
    hero: {
      ...
      waitlistDescription: 'Create your account and access your personalized experience right away.',
    },
    whatItIs: {
