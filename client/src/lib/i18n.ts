...
export const copy = {
  fr: {
    ...
    cta: {
      ...
      description: 'Sois parmi les premiers à jaser avec Cathy. Laisse ton courriel.',
      placeholder: 'Ton courriel',
      button: 'Je veux être dedans',
      secondaryButton: 'J\'ai déjà un compte',
      success: 'T\'es dedans! On te revient bientôt. 🎤',
      already: 'T\'es déjà sur la liste! Patience. 😏',
      error: 'Oups. Réessaie.',
    },
    footer: {
  ...
  en: {
    ...
    cta: {
      ...
      description: 'Be among the first to chat with Cathy. Drop your email.',
      placeholder: 'Your email',
      button: 'Count me in',
      secondaryButton: 'I already have an account',
      success: 'You\'re in! We\'ll be in touch soon. 🎤',
      already: 'You\'re already on the list! Hang tight. 😏',
